...
if ($stmt = mysqli_prepare($conn, $sql)) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        // Set error message
        $_SESSION['message'] = "Error retrieving project details";
        $_SESSION['message_type'] = "danger";
    }
...
$referrer = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : BASE_URL . "/pages/dashboard.php";

// If the referrer was the project details page of the deleted project, redirect to dashboard instead
if (strpos($referrer, "project-details.php?id=" . $project_id) !== false) {
    $referrer = BASE_URL . "/pages/dashboard.php";
}
